...
namespace Pandaros.SchematicBuilder
{
    ...
    public static class SchematicBuilderLogger
    {
        private static CSConsoleAndFileLogger _logger = new CSConsoleAndFileLogger(GameLoader.NAMESPACE, "SchematicBuilderLog", "<Panaros => SchematicBuilder>");
