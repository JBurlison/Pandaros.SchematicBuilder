...
namespace Pandaros.SchematicBuilder.Jobs.Construction
{
        ...
        {
            {
                ...
                {
                    new RecipeUnlock(GameLoader.NAMESPACE + ".SchematicTool", ERecipeUnlockType.Recipe)
                }
            }
        };
    ...
    public class SchematicMenu
    {
        ...
        private static void SendMainMenu(Players.Player player)
        {
            ...
            menu.Items.Add(new DropDown(new LabelData(_localizationHelper.GetLocalizationKey("Schematic"), UnityEngine.Color.black), Selected_Schematic, options.Select(fi => fi.Name.Replace(".csschematic", "")).ToList()));
